...
def read_logic(s, logic_parser=..., encoding=...):
    """
...
def unique_variable(pattern=..., ignore=...):
    """
...
def skolem_function(univ_scope=...):
    """
...
def typecheck(expressions, signature=...):
    """
...
class Expression(SubstituteBindingsI):
    ...
    @classmethod
    def fromstring(cls, s, type_check=..., signature=...):
        ...
