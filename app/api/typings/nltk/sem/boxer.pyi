...
class Boxer(object):
    ...
    def set_bin_dir(self, bin_dir, verbose=...):
        ...
    ...
    def interpret_sents(self, inputs, discourse_ids=..., question=..., verbose=...):
        """
        Use Boxer to give a first order representation.
    ...
    def interpret_multi_sents(self, inputs, discourse_ids=..., question=..., verbose=...):
        """
        Use Boxer to give a first order representation.
