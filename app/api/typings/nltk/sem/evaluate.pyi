...
class Model(object):
    ...
    def evaluate(self, expr, g, trace=...):
        """
    ...
    def satisfy(self, parsed, g, trace=...):
        """
    ...
    def satisfiers(self, parsed, varex, g, trace=..., nesting=...):
        """
