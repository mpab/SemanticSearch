...
class MaxentClassifier(ClassifierI):
    ...
    ALGORITHMS = ...
    @classmethod
    def train(cls, train_toks, algorithm=..., trace=..., encoding=..., labels=..., gaussian_prior_sigma=..., **cutoffs):
        """
...
class BinaryMaxentFeatureEncoding(MaxentFeatureEncodingI):
    ...
    @classmethod
    def train(cls, train_toks, count_cutoff=..., labels=..., **options):
        """
        Construct and return new feature encoding, based on a given
...
def train_maxent_classifier_with_megam(train_toks, trace=..., encoding=..., labels=..., gaussian_prior_sigma=..., **kwargs):
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
