...
"""
def chomsky_normal_form(tree, factor=..., horzMarkov=..., vertMarkov=..., childChar=..., parentChar=...):
    ...

def un_chomsky_normal_form(tree, expandUnary=..., childChar=..., parentChar=..., unaryChar=...):
    ...

def collapse_unary(tree, collapsePOS=..., collapseRoot=..., joinChar=...):
    """
