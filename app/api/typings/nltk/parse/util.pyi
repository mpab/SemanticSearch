...
"""
def load_parser(grammar_url, trace=..., parser=..., chart_class=..., beam_size=..., **load_args):
    """
...
def extract_test_sentences(string, comment_chars=..., encoding=...):
    """
