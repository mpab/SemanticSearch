...
class CFG(object):
    ...
    @classmethod
    def fromstring(cls, input, encoding=...):
        """
    ...
    def productions(self, lhs=..., rhs=..., empty=...):
        """
    ...
    def chomsky_normal_form(self, new_token_padding=..., flexible=...):
        """
...
class FeatureGrammar(CFG):
    ...
    @classmethod
    def fromstring(cls, input, features=..., logic_parser=..., fstruct_reader=..., encoding=...):
        """
...
_TERMINAL_RE = ...
_DISJUNCTION_RE = ...
def read_grammar(input, nonterm_parser, probabilistic=..., encoding=...):
    """
