...
class DiscourseTester(object):
    ...
    def add_sentence(self, sentence, informchk=..., consistchk=...):
        """
    ...
    def retract_sentence(self, sentence, verbose=...):
        """
    ...
    def readings(self, sentence=..., threaded=..., verbose=..., filter=..., show_thread_readings=...):
        """
    ...
    def expand_threads(self, thread_id, threads=...):
        """
    ...
    def models(self, thread_id=..., show=..., verbose=...):
        """
    ...
    def add_background(self, background, verbose=...):
        """
...
def discourse_demo(reading_command=...):
    """
    Illustrate the various methods of ``DiscourseTester``
    """
    ...

def drt_discourse_demo(reading_command=...):
    """
    Illustrate the various methods of ``DiscourseTester``
    """
    ...
