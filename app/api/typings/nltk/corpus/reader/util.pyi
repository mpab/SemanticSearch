...
class PickleCorpusView(StreamBackedCorpusView):
    ...
    BLOCK_SIZE = ...
    PROTOCOL = ...
    def __init__(self, fileid, delete_on_gc=...) -> None:
        """
    ...
    @classmethod
    def cache_to_tempfile(cls, sequence, delete_on_gc=...):
        """
...
def read_regexp_block(stream, start_re, end_re=...):
    """
...
def read_sexpr_block(stream, block_size=..., comment_char=...):
    """
