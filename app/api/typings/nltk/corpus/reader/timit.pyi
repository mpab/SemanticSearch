...
class TimitCorpusReader(CorpusReader):
    ...
    def utteranceids(self, dialect=..., sex=..., spkrid=..., sent_type=..., sentid=...):
        """
    ...
    def phones(self, utterances=...):
        ...
    
    def phone_times(self, utterances=...):
        """
        offset is represented as a number of 16kHz samples!
        """
        ...
    
    def words(self, utterances=...):
        ...
    
    def word_times(self, utterances=...):
        ...
    
    def sents(self, utterances=...):
        ...
    
    def sent_times(self, utterances=...):
        ...
    
    def phone_trees(self, utterances=...):
        ...
    
    def wav(self, utterance, start=..., end=...):
        ...
    
    def audiodata(self, utterance, start=..., end=...):
        ...
    
    def play(self, utterance, start=..., end=...):
        """
