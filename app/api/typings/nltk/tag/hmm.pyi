...
class HiddenMarkovModelTagger(TaggerI):
    ...
    @classmethod
    def train(cls, labeled_sequence, test_sequence=..., unlabeled_sequence=..., **kwargs):
        """
    ...
    def test(self, test_sequence, verbose=..., **kwargs):
        """
...
class HiddenMarkovModelTrainer(object):
    ...
    def train(self, labeled_sequences=..., unlabeled_sequences=..., **kwargs):
        """
    ...
    def train_unsupervised(self, unlabeled_sequences, update_outputs=..., **kwargs):
        """
    ...
    def train_supervised(self, labelled_sequences, estimator=...):
        """
...
def demo_pos_bw(test=..., supervised=..., unsupervised=..., verbose=..., max_iterations=...):
    ...
