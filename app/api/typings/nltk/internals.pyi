...
_java_bin = ...
_java_options = ...
def config_java(bin=..., options=..., verbose=...):
    """
...
def java(cmd, classpath=..., stdin=..., stdout=..., stderr=..., blocking=...):
    """
...
def find_binary_iter(name, path_to_bin=..., env_vars=..., searchpath=..., binary_names=..., url=..., verbose=...):
    """
    Search for a file to be used by nltk.
...
def slice_bounds(sequence, slice_obj, allow_step=...):
    """
